const playingCards = (function() {
  ...
  function renderReport() {
    let str = '';
    let cats = ['덱','포켓', '없음', '원페어', '투페어', '트리플', '스트레이트', '플러시', '풀하우스', '포카드', '스트레이트 플러시', '로열 플러시'];
    //let cats = ['덱','Hands', '없음', '원페어', '투페어', '트리플', '스트레이트', '플러시', '풀하우스', '포카드', '스트레이트 플러시', '로열 플러시', '0 Hands', '1 Hands', '2 Hands', '3 Hands', '4 Hands', '5 Hands', '6 Hands', '7 Hands', '8 Hands', '9 Hands', '10 Hands'];
